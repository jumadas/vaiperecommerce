...
@section('og_image')
 <meta property="og:image" content="{{ asset('uploads/product_photos')}}/{{$single_product_details->product_photo}}">
{{-- <meta property="og:image" content="{{ asset('uploads/product_photos')}}/{{$single_product_details->product_photo}}"> --}}
@endsection
@section('content')
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-12 text-center">
                    ...
                    <ul class="breadcrumb-list">
                        ...
                        <li class="breadcrumb-item active">{{ $single_product_details->product_name }}</li>
                    </ul>
                    <!-- breadcrumb-list end -->
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-12 col-xs-12 mb-lm-30px mb-md-30px mb-sm-30px">
                    ...
                    <div class="swiper-container zoom-top">
                        ...
                        <div class="swiper-wrapper">
                            @foreach ( App\Models\Product_thumnail::where('product_id',$single_product_details->id)->get() as $thumbnails)
                                <div class="swiper-slide zoom-image-hover">
                                    <img class="img-responsive m-auto" src="{{ asset('uploads/product_thumbnails') }}/{{ $thumbnails->product_thumbnail_name }}"
                                        alt="">
                                </div>
                            @endforeach
                ...
                <div class="col-lg-6 col-sm-12 col-xs-12" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="product-details-content quickview-content">
                        ...
                        <small>Stock Available:{{ $single_product_details->product_quantity  }}</small>
                        <div class="pricing-meta">
                            <ul>
                                <li class="old-price not-cut">${{ $single_product_details->product_price }}</li>
                            </ul>
                        </div>
                        ...
                        <p class="mt-30px mb-0">{{ $single_product_details->product_short_description }} </p>
                         <form action="{{ route('addcart', $single_product_details->id) }}" method="POST">
                            ...
                            @auth
                                 <div class="pro-details-compare-wishlist pro-details-wishlist ">
                                     ...
                                     @else
                                        <a href="{{ route('wishlist.insert', $single_product_details->id) }}"><i class="fa fa-heart-o"></i></a>
                                     @endif
                        ...
                        <div class="pro-details-sku-info pro-details-same-style  d-flex">
                            ...
                            <ul class="d-flex">
                                <li>
                                    <a href="#">{{ $single_product_details->product_code}}</a>
                                </li>
                            </ul>
                        </div>
                        <div class="pro-details-categories-info pro-details-same-style d-flex">
                            ...
                            <ul class="d-flex">
                                <li>
                                    <a href="{{ route('categorywiseproducts',$single_product_details->category_id) }}">
                                        {{-- {{App\Models\Category::find($single_product_details->category_id)->category_name }}</a> --}}
                                        {{-- relationship use Product Table and Category Table --}}
                                        {{$single_product_details->relationtocategory->category_name }}
