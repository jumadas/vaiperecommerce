            ...
            <div class="row">
                <div class="col-lg-12 order-lg-last col-md-12 order-md-first">
                    ...
                    <div class="shop-top-bar d-flex">
                        <!-- Left Side start -->
                        <p><span>{{ $products->count() }}</span> Product Found of <span>{{ $all_product_count }}</span></p>
                        <!-- Left Side End -->
                                                        ...
                                                        <div class="product">
                                                            <div class="thumb">
                                                                <a href="single-product.html" class="image">
                                                                    <img src="{{asset('uploads/product_photos')}}/{{ $product->product_photo }}"
                                                                        alt="Product" />
