...
<body>
                ...
                <div class="row">
                    <div class="col-auto align-self-center">
                        <div class="header-logo">
                            <a href="{{ route('frontend') }}"><img src="{{asset('frontend')}}/assets/images/logo/logo.png" alt="Site Logo" /></a>
                        </div>
                    </div>
                    ...
                    <div class="col col-lg-auto align-self-center pl-0">
                        <div class="header-actions">
                            ...
                            <a href="#offcanvas-cart"
                                ...
                                <span class="header-action-num">{{ totalproducttocart() }}</span>
    ...
    <div id="offcanvas-wishlist" class="offcanvas offcanvas-wishlist">
        <div class="inner">
            ...
            {{-- @php
               echo App\Models\Wishlist::where('user_id',auth()->id())->get();
            @endphp --}}
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    @forelse (allwishlist() as $wishlist)
                         <li>
                        <a href="single-product.html" class="image"><img src="{{ url('uploads/product_photos') }}/{{  App\Models\Product::find($wishlist->product_id)->product_photo }} "
                    ...
                    @empty
                    <div class="alert alert-danger">No Product In Wishlist</div>
                    @endforelse
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
               ...
               @foreach (allcarts()  as $cart)
                   <li>
                        <a href="single-product.html" class="image"><img src="{{asset('uploads/product_photos') }}/{{ $cart->relationtoproduct->product_photo }}"
                                alt="Cart product Image"></a>
                        <div class="content">
